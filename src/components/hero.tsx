...
export default function Hero() {
  return (
    <div className="py-6 sm:py-14 ">
      ...
      <main className="relative container mt-4 mb-20 sm:mb-0 max-w-7xl px-4 py-8 mx-auto">
        <div className="relative sm:overflow-hidden">
          <div className="border-primary/20 bg-background/70 shadow-primary/10 relative flex flex-col items-start justify-start rounded-xl border px-4 pt-12 shadow-xl backdrop-blur-md max-md:text-center md:px-12 md:pt-16">
            <div
              className="animate-gradient-x absolute inset-0 top-32 z-0 hidden blur-3xl dark:block"
              style={{
                maskImage:
                  'linear-gradient(to bottom, transparent, white, transparent)',
                background:
                'repeating-linear-gradient(65deg, red, pink 40px, transparent 10px, transparent 200px)',
            ...
            <div
              ...
              style={{
                maskImage:
                  'linear-gradient(to bottom, transparent, white, transparent)',
                background:
  'repeating-linear-gradient(65deg, red, blue 12px, transparent 20px, transparent 200px)',
                backgroundSize: '200% 100%',
              }}
            />
            <h1 className="mb-4 flex flex-wrap gap-2 text-3xl leading-tight font-medium md:text-5xl">
              Discover, Test & Integrate APIs Faster with <span className="text-primary">API'VERSE</span>
            </h1>
            <p className="text-muted-foreground mb-8 text-left md:max-w-[80%] md:text-xl">
              API'VERSE is your one-stop hub to explore, test, and integrate APIs with ease. Find trusted APIs, manage subscriptions, and accelerate your development workflow.
            </p>
            <div className="mb-6 flex flex-wrap gap-4 md:flex-row">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Developer Friendly Tools</span>
              </div>
            </div>
            ...
            <div className="relative z-10 mt-16 w-full">
              ...
              <div className="animate-in fade-in slide-in-from-left-4 absolute -top-6 -right-6 rotate-6 transform rounded-lg bg-white p-3 shadow-lg dark:bg-neutral-900">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">Ready-to-Use APIs</span>
                </div>
              </div>
            </div>
          </div>
