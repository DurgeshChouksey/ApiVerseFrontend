...
const defaultTestimonials = [
  {
    text: 'API\'VERSE made integrating multiple APIs seamless. I built my dashboard in hours instead of days.',
  ...
  {
    text: 'The analytics and logs feature is a game-changer. I can monitor API performance in real-time effortlessly.',
    imageSrc: 'https://i.pravatar.cc',
    name: 'Sara Lin',
    username: '@sara.codes',
    role: 'UX Designer',
  ...
  {
    text: 'Creating and testing APIs is so smooth with API\'VERSE. Our team launched multiple microservices quickly.',
    imageSrc: 'https://i.pravatar.cc',
    name: 'Devon Carter',
    username: '@devninja',
  ...
  {
    text: 'The subscription and key management features saved us hours of backend work. Everything is well-organized.',
    imageSrc: 'https://i.pravatar.cc',
    name: 'Priya Shah',
    username: '@priyacodes',
  ...
  {
    text: 'API\'VERSE\'s documentation and ready-to-use endpoints helped us prototype faster than ever.',
    imageSrc: 'https://i.pravatar.cc',
    name: 'Leo Martin',
    username: '@leobuilds',
  ...
  {
    text: 'From testing to logging, API\'VERSE provides everything a developer needs to manage APIs efficiently.',
    imageSrc: 'https://i.pravatar.cc',
    name: 'Chloe Winters',
...
export default function Testimonials({
  ...
  subtitle = 'From API management to real-time analytics, API\'VERSE helps developers build, monitor, and scale APIs effortlessly.',
  autoplaySpeed = 3000,
  className,
}: TestimonialProps) {
