...
const features = [
  {
    ...
    title: 'Discover APIs',
    content:
      "Browse thousands of public and private APIs across multiple categories, all in one place.",
  ...
  },
  {
    ...
    content:
      "Run and test APIs directly in your browser with our built-in playground.",
  ...
  },
  {
    ...
    content:
      "Keep track of API usage, keys, and analytics with our developer dashboard.",
  ...
  },
  {
    ...
    content:
      "Bookmark, rate, and share your favorite APIs with the API'VERSE community.",
    icon: <Code className="text-primary h-6 w-6" />,
    image:
      'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop',
  },
...
export default function Features() {
  ...
  return (
    <div className={'p-8 md:p-12 mt-15 sm:mt-0'}>
        ...
        <div className="relative mx-auto mb-12 max-w-2xl sm:text-center">
          <div className="relative z-10">
            <h2 className="from-foreground to-foreground/40 mb-4 bg-gradient-to-b bg-clip-text text-3xl font-bold text-transparent md:text-5xl lg:text-6xl">
              Explore APIs in Four Steps
            </h2>
            <p className="font-geist text-foreground/60 mt-3">
              API'VERSE helps developers discover, test, and manage APIs faster than ever before.
            </p>
          </div>
          <div
