...
const defaultValues: AboutUsProps['values'] = [
  {
    title: 'Innovation',
    description:
      'Continuously evolving with modern tools to make API management smarter and more intuitive.',
    icon: 'Lightbulb',
  },
  {
    title: 'Collaboration',
    description:
      'Creating a connected ecosystem where developers and organizations can share and collaborate on APIs easily.',
    icon: 'Users',
  },
  {
    title: 'Transparency',
    description:
      'Ensuring clear communication, open documentation, and reliable data for every API listed on the platform.',
    icon: 'Sparkles',
  },
  {
    title: 'Impact',
    description:
      'Empowering developers and businesses worldwide to build better software through easy access to APIs.',
    icon: 'Globe',
  },
];
...
export default function AboutUs() {
  const aboutData = {
    title: `About API'Verse`,
    subtitle:
      'Empowering developers with a unified API marketplace for seamless discovery and integration.',
    mission:
      'At ApiVerse, our mission is to simplify API discovery, integration, and collaboration. We help developers explore, test, and connect APIs efficiently with a clean, secure, and user-friendly experience.',
    vision:
      'To become the go-to global platform for developers and businesses to discover, share, and monetize APIs effortlessly.',
